...
geo3d.prototype.draw_FillingArea = function(){
...
geo3d.prototype.draw_samples = function(){
    var baselineCanvas = document.getElementById("baselineCanvas");
    var context = baselineCanvas.getContext("2d");
...
geo3d.prototype.draw_ghost = function(){
...
geo3d.prototype.select_vertex = function(tapPosScreen){
    var nearest = 20;
...
geo3d.prototype.clone_sample = function(){
    this.ghost = {
...
geo3d.prototype.isFillable = function(sample){
    var self = this;
    var fillable = true;
    var samplecenter = sample.center;
    sample.slots.forEach(function(slot){
...
geo3d.prototype.rotate = function(sample){
    sample.slots.forEach(function(slot){
        var x = slot.y;
        var y = -slot.x;
        slot.x = x;
