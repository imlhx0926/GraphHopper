Gh.define("DOMBinding", [], function () {
    ...
    function bindModel(name) {
        Gh.log("binding model: " + name);

        var model = Gh.use(name);
